...
const css = `
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
  ...
  .auth-page-top{display:flex;align-items:center;justify-content:space-between;gap:16px;margin-bottom:64px;}
  @media(max-width:768px){.auth-page-top{margin-bottom:40px;}}
  .auth-header-photo{height:90px;width:150px;object-fit:cover;border-radius:14px;border:1px solid rgba(255,255,255,.1);box-shadow:0 10px 24px rgba(0,0,0,.3);}
  @media(max-width:992px){.auth-header-photo{height:70px;width:120px;}}
  @media(max-width:560px){.auth-header-photo{display:none;}}
  ...
  .auth-feature-card{background:var(--auth-surface);border:1px solid var(--auth-border);border-radius:10px;padding:10px;min-height:92px;backdrop-filter:blur(18px);box-shadow:0 7px 18px rgba(0,0,0,.18);transition:all .3s ease;display:flex;flex-direction:column;}
  ...
  .auth-feature-dot{width:20px;height:20px;border-radius:6px;background:rgba(220,38,38,0.1);border:1px solid rgba(220,38,38,0.3);color:var(--auth-accent);display:flex;align-items:center;justify-content:center;margin-bottom:6px;flex-shrink:0;}
  .auth-feature-label{font-size:11px;font-weight:700;line-height:1.25;margin-bottom:4px;color:#fff;}
  .auth-feature-desc{font-size:9px;line-height:1.4;color:rgba(255,255,255,.72);}
  ...
  .auth-travel-banner-wrap{margin-bottom:60px;}
  .auth-travel-banner{width:100%;height:240px;object-fit:cover;border-radius:24px;border:1px solid rgba(255,255,255,.08);box-shadow:0 18px 45px rgba(0,0,0,.22);display:block;}
  @media(max-width:768px){.auth-travel-banner{height:160px;border-radius:16px;}.auth-travel-banner-wrap{margin-bottom:40px;}}
...
const AUTH_PHOTO_PARENT_CHILD = "https://images.unsplash.com/photo-1554200991-de2527940354?auto=format&fit=crop&w=480&q=70";
const AUTH_PHOTO_PIZZA = "https://images.unsplash.com/photo-1753351055582-67172f8c4d27?auto=format&fit=crop&w=480&q=70";
const AUTH_PHOTO_RENOVATION = "https://images.unsplash.com/photo-1511822148790-e7b58ba14c72?auto=format&fit=crop&w=480&q=70";
const AUTH_PHOTO_TRAVEL = "https://images.unsplash.com/photo-1536607961765-592e80bcc19e?auto=format&fit=crop&w=1200&q=70";
  ...
  return (
    <div className="auth-page">
      <div className="auth-page-top auth-container">
        ...
        <img
          src={AUTH_PHOTO_RENOVATION}
          alt="Roommates renovating their home together"
          className="auth-header-photo"
        />
      </div>
      ...
      <div className="auth-hero-row auth-container">
        ...
        <div className="auth-hero-photos">
          ...
          <img
            ...
            alt="Parent carrying their child"
            className="auth-collage-img"
      ...
      <div className="auth-container auth-travel-banner-wrap">
        <img
          src={AUTH_PHOTO_TRAVEL}
          alt="Friends traveling together on a mountain trail"
          className="auth-travel-banner"
        />
      </div>
